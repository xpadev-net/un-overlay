...
public class OverlayWindowManager : MonoBehaviour {
    ...
    private void HandleInput()
    {
        ...
        {
            if (!isScreenMoving&&util.IsControllerButtonPressed(util.GetLeftControllerIndex(), EVRButtonId.k_EButton_Grip) && WindowControl.instance.TryToGrubWindow())
            {
                isScreenMoving = true;
        ...
        {
            if (!isScreenMoving&&util.IsControllerButtonPressed(util.GetRightControllerIndex(), EVRButtonId.k_EButton_Grip) && WindowControl.instance.TryToGrubWindow())
            {
                isScreenMoving = true;
