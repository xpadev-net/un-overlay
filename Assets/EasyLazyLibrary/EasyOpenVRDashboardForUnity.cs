...
namespace EasyLazyLibrary
{
    public class EasyOpenVRDashboardForUnity : MonoBehaviour
    {
        ...
        [Header("Error")] public bool error = false;
        public bool eventlog = true;

        [Header("Mouse (Read only)")] public float MouseX = 0.0f;
...
#pragma warning restore 0414
        ...
        void Start()
        {
            ...
            overlayError = overlay.CreateDashboardOverlay(OverlayKeyName, OverlayFriendlyName, ref overlayHandle,
                ref thumbnailHandle);
